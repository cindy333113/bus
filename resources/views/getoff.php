            ...
            <div class="breadcrumb-wrap">
              <nav aria-label="breadcrumb">
                ...
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">預約下車</li>
                </ul>
              </nav>
            </div>
          </div>
                    ...
                    <?php foreach ($List as $key => $getoffdata) { ?>
                      <tr>
                        <td class="pro-thumbnail">
                          <?= $getoffdata['route']['route_name'] ?>
                        </td>
                        <td class="pro-quantity">
                          <?= $getoffdata['getoff']['direction'] ? '去程' : '回程' ?>
                        </td>
                        <td class="pro-price">
                          <span>
                            <?= $getoffdata['stop']['stop_name'] ?>
                          </span>
                        </td>
                        <td class="pro-title">
                          <span class="text-success">
                            <?= findStopNameByBus($getoffdata['bus']['bus_id']) ?>
                          </span>
                        </td>
                        <td class="pro-subtotal">
                          <?= $getoffdata['getoff']['unusal'] ? '✔︎' : '✗' ?>
                        </td>
                        <td class="pro-remove">
                          <form name="deleteForm<?= $getoffdata['getoff']['getoff_id'] ?>" action="/passenger/getoff/delete" method="post">
                            <input type="hidden" name="id" value=<?= $getoffdata['getoff']['getoff_id'] ?> />
                            <span>
                              <a href="javascript:document.deleteForm<?= $getoffdata['getoff']['getoff_id'] ?>.submit();">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 order-1 order-lg-2">
            ...
            <div class="product-details-inner">
              ...
              <div class="row">
                <form name="addGetOff" action="/passenger/getoff/add" method="post">
                  <div class="col-lg-6">
