                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="formLogin" method="POST" class="formLogin">
								...
								<div class="row mb-3">
									<div class="col-lg-12 text-right"><button type="submit" class="btn btn-success hover-btn btn-wd " id="btnLogin"><span>send it</span></button></div>
								</div>
                            </form>
							...
							<div class="row">
								...
								<a href="#" class="text-black text-small">已經是會員</a>
									</div>
								</div>
							</div>
                        </div>
