...
<tr>
<td>
<form action="/plantroute" method="post">
  ...
  <p></p>
  <button class="" type="submit" name="規劃路線" value="plan" class="form-control btn btn-primary" style="position: relative; left:27%;border-radius:10%" onclick="/planroute" method="post">規劃路線</button>
</td>
