                      ...
                      <div class="col-md d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services text-center d-block">
                          ...
                          <div class="media-body">
                            <h3 class="heading mb-3">搜尋公車</h3>
                            <p class="mb-0"><a href="/destination" class="btn btn-white px-4 py-3">More...</a></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-md d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services text-center d-block">
                          ...
                          <div class="media-body">
                            <h3 class="heading mb-3">我的最愛</h3><br>
                            <p class="mb-0"><a href="/myfavourite" class="btn btn-white px-4 py-3">More...</a></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-md d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services text-center d-block">
                          ...
                          <div class="media-body">
                            <h3 class="heading mb-3">路線搜尋</h3>
                            <p class="mb-0"><a href="/planroute" class="btn btn-white px-4 py-3">More...</a></p>
                          </div>
                        </div>
                      </div>
                    </div>
